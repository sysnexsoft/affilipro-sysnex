    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="mb-0 fw-semibold">Create Role</h4>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <form action="{{ route('admin.role.permission.store') }}" method="post">
                        ...
                        <div class="card floating-card bg-transparent mb-1">
                            <div class="card-body d-flex bg-transparent justify-content-end">
                        ...
                        <div class="card card-body p-4">
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><b>Role
                                        Name</b></label>
                                <div class="col-sm-6">
